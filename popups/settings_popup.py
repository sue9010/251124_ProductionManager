...
class SettingsPopup(BasePopup):
    def __init__(self, parent, data_manager, refresh_callback):
        # [수정] req_no를 전달하지 않음 -> 사이드바 없이 생성됨
    ...
    def create_widgets(self):
        ...
        ctk.CTkLabel(parent, text="엑셀 파일 경로 설정", font=FONTS["header"]).pack(pady=(20, 10), padx=20, anchor="w")
        ...
        ctk.CTkButton(parent, text="저장 및 적용", command=self.save, fg_color=COLORS["primary"], hover_color=COLORS["primary_hover"]).pack(pady=30)
